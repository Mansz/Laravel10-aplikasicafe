        ...
        <div class="middle-content container-xxl p-0">
            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Data Non Foods</a></li>
                        
                    </ol>
                    <a href="/tambah/non-foods" class="btn btn-primary">Tambah Data </a>
                </nav>
            </div>
            <!-- /BREADCRUMB -->
                                ...
                                @foreach ($produks as $index => $produk)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('non-foods.edit', Crypt::encrypt($produk->id)) }}"
                                                class="badge rounded-pill bg-primary">Edit</a>
                                            <a href="{{ route('delete.non-foods', $produk->id) }}"
